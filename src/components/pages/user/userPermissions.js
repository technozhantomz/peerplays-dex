...
import {fetchPermissions} from "../../../actions/dataFetching/fetchPermissions";
    ...
    render() {
        ...
        return (
            <div className="permissions">
                ...
                <div className={`save-changes ${showSave ? 'shown' : ''}`}>
                    <div className="container">
                        <div className="save-changes__fee">
                            <span>Commission</span>
                            <span>{changeLog.fee} {defaultToken}</span>
                        </div>
                        <div className="save-changes__btn-wrapper">
                            <button onClick={this.reset}>CANCEL</button>
                            <button className="btn-round" onClick={this.handleSave}>Save Changes</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default dataFetch(fetchPermissions)(UserPermissions);